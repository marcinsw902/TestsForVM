...
public class LoginPage {
    ...
    public LoginPage(WebDriver webDriver, SoftAssertions softly, String player1, String player2){
    ...
    public LoginPage validateLoginLabels(){
